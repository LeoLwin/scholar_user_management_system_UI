...
function EditFeatureForm({ editModal, roleData, onSave }: ModalProps) {
  ...
  return (
    <Modal isOpen={editModal.isOpen} onClose={editModal.closeModal} className="max-w-[500px] w-full m-4">
