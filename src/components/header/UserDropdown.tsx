...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
         <div className="w-12 h-12 overflow-hidden border rounded-full bg-brand-500 text-white dark:border-gray-800 me-2">
          <div className="flex h-full w-full items-center justify-center font-bold text-xl tracking-tight">
            <NameAvatar name={auth.user?.name} />
          </div>
        </div>   
